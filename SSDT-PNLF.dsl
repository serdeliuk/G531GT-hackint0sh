 ...
 *
 * Disassembly of SSDT-PNLF.aml, Wed May 27 10:37:13 2020
 *
 ...
 */
DefinitionBlock ("", "SSDT", 13, "mshack", "_PNLF", 0x00000013)
{
            ...
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                ...
                If (LEqual (One, Local3))
                {
                    ...
                    If (LNotEqual (Local2, Local1))
                    {
                        ...
                        {
                            Store (Local3, ^LEVX) /* \_SB_.PCI0.IGPU.PNLF.LEVX */
                ...
                ElseIf (LEqual (0x02, Local3))
                {
                    ...
                    If (LEqual (Zero, And (0x02, Local4)))
                    {
                        ...
                        Store (Local5, ^LEVW) /* \_SB_.PCI0.IGPU.PNLF.LEVW */
                    }
                    ...
                    If (And (0x04, Local4))
                    {
                        ...
                        {
                            Store (\RMCF.GRAN, ^GRAN) /* \_SB_.PCI0.IGPU.PNLF.GRAN */
                        }
                        Else
                        {
                            Store (Zero, ^GRAN) /* \_SB_.PCI0.IGPU.PNLF.GRAN */
                        }
                    }
                    ...
                    If (LNotEqual (Local2, Local1))
                    {
                        ...
                        Store (Local0, ^LEVX) /* \_SB_.PCI0.IGPU.PNLF.LEVX */
                    }
                }

                If (LEqual (Local2, 0x0710))
                {
                    Store (0x0E, _UID) /* \_SB_.PCI0.IGPU.PNLF._UID */
                }
                ElseIf (LEqual (Local2, 0x0AD9))
                {
                    Store (0x0F, _UID) /* \_SB_.PCI0.IGPU.PNLF._UID */
                }
                ElseIf (LEqual (Local2, 0x056C))
                {
                    Store (0x10, _UID) /* \_SB_.PCI0.IGPU.PNLF._UID */
                }
                ElseIf (LEqual (Local2, 0x07A1))
                {
                    Store (0x11, _UID) /* \_SB_.PCI0.IGPU.PNLF._UID */
                }
                ElseIf (LEqual (Local2, 0x1499))
                {
                    Store (0x12, _UID) /* \_SB_.PCI0.IGPU.PNLF._UID */
                }
                ElseIf (LEqual (Local2, 0xFFFF))
                {
                    Store (0x13, _UID) /* \_SB_.PCI0.IGPU.PNLF._UID */
                }
                Else
                {
                    Store (0x63, _UID) /* \_SB_.PCI0.IGPU.PNLF._UID */
                }
            }
        }
    }
